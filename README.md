...
```bash
sudo apt install -y git && git clone https://github.com/rafaelbok/installpress.git instalador && sudo chmod -R 777 ./instalador && cd ./instalador && sudo ./install_primaria
```
